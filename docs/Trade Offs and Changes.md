...
In terms of the actual analysis, that can be seen in ['ACT Analysis'](https://github.com/iaketepe/Brazilian-Ecommerce-Dashboard/blob/dev/docs/Act-Analysis.md). Other than that, the only thing left I had to cover was organizing the data so it could be sent to storage. I thought of it in 3 segments:
